class PersonController < ApplicationController
  ...
  def create
    ...
    if person.save
      redirect_to action: :index, flash: {"success" => "Person has been created."}
    else
  ...
  def update
    ...
    if person.save
      redirect_to action: :index, flash: {"success" => "Person has been updated."}
    else
  ...
  def destroy
    person.destroy
    redirect_to action: :index, flash: {"success" => "Person has been deleted."}
  end
